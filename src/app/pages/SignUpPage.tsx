        ...
        <Card className="border-2 border-emerald-100 shadow-2xl">
          <CardContent className="p-8">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-slate-800 mb-2">{t("auth.createAccount")}</h1>
              <p className="text-slate-600">{t("auth.startHealthJourney")}</p>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <Button type="submit" disabled={loading} className="w-full bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-700 hover:to-emerald-700 text-white py-3 font-medium">
            ...
            <p className="text-center mt-6 text-slate-600">
              {t("auth.haveAccount")}{" "}
              <Link to="/login" className="text-emerald-600 hover:text-emerald-700 font-medium">{t("auth.signInHere")}</Link>
            </p>
          </CardContent>
        </Card>
      </div>
