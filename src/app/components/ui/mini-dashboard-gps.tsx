...
interface MiniDashboardGPSProps {
  className?: string;
}

export function MiniDashboardGPS({ className }: MiniDashboardGPSProps) {
  ...
  return (
    <Card className={`w-full border border-blue-200 shadow-md bg-gradient-to-br from-blue-50 to-emerald-50 ${className}`}>
      <CardContent className="p-4">
        <div className="space-y-3">
          <div className="text-center">
            ...
            <h3 className="text-sm font-bold text-gray-900 mb-2">🗺️ Find Nearby Clinics</h3>
          </div>
          ...
          <div className="space-y-2">
            <Button
              ...
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-700 hover:to-emerald-700 text-white text-sm py-2"
            >
              {isLoading ? (
            ...
            <Button
              ...
              variant="outline"
              className="w-full border border-blue-600 text-blue-600 hover:bg-blue-50 text-sm py-2"
            >
              <div className="flex items-center justify-center space-x-2">
          ...
          {nearestClinics.length > 0 && (
            <div className="space-y-2">
              <h4 className="text-sm font-semibold text-gray-900 mb-2">🏥 Nearest Clinics:</h4>
              <div className="space-y-2">
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <h5 className="text-sm font-semibold text-gray-900">{clinic.name}</h5>
