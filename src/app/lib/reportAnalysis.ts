export interface AnalysisResult {
  ...
  /** Likely or commonly associated symptoms inferred from the report context. */
  symptoms: string[];
  /** Preventive / lifestyle steps that can help reduce risk. */
  prevention: string[];
  /** Longer-term monitoring and follow-up suggestions. */
...
Status: use "normal" for within range, "attention" for borderline, "critical" for out of range or concerning. Do NOT add any fields beyond the ones specified above.`,
  ...
  // Normalise optional arrays so the UI can rely on them.
